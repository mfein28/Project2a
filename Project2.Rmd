...
library(dplyr)
=======
>>>>>>> da787e04128f74784cbf01e8aa39e1529e0577d1
...
packages <- c('ggplot2', 'qwraps2', 'memisc', 'pander', 'kableExtra', 'plotly', 'zipcode', 'scales', 'tidyverse')
...
```{r}
<<<<<<< HEAD
listings <- read.csv('~/Project2a/listings.csv')
...
neighborhoodClusters <- subset(neighborhoodClusters, select=c("NAME", "NBH_NAMES"))
names(neighborhoodClusters) <- c('Cluster', 'neighbourhood')
listings <- left_join(neighborhoodClusters, listings, by="neighbourhood")
